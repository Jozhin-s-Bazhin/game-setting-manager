...
def test_save_multiple_files(tmp_path):
    ...
    testing_tools.create_test_env(tmp_path, "empty_data_dir", 1)  # Create testing environment with one game and an empty data directory
    save_profile("game_1", "profile_1", [f"{tmp_path}/game_1/config_file", f"{tmp_path}/game_1/another_config_file"], f"{tmp_path}/data")  # Run function
...
def test_save_full_data_dir(tmp_path):
    ...
    save_profile("game_1", "profile_1", [f"{tmp_path}/game_1/config_file"], f"{tmp_path}/data")  # Run function to create data inside the data directory
    save_profile("game_1", "profile_1", [f"{tmp_path}/game_1/config_file"], f"{tmp_path}/data")  # Run function to test it
...
def test_save_no_saved_game(tmp_path):
    ...
    with pytest.raises(PathError) as exception_info:
        save_profile("game_1", "profile_1", [], f"{tmp_path}/data")
